...
public class ImageQueueAdapter extends BaseAdapter {
	Context context;
	...
	public ImageQueueAdapter(Context context) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			ImageQueueAdapter.ViewHolder viewHolder = new ViewHolder();
		...
		final ImageQueueAdapter.ViewHolder viewHolder = (ImageQueueAdapter.ViewHolder) view
				.getTag();
